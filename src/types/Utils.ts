...
export type SourceSearchPlatformBase = string

export type DuncteSearchPlatform = string

export type ExtendedSearchPlatform = string

export type AudioClientSearchPlatform = string
export type AudioClientSearchPlatformResolve = string

export type RyanlinkSearchPlatform = string

export type ClientCustomSearchPlatformUtils = 'local' | 'http' | 'https' | 'link' | 'uri'

export type ClientSearchPlatform = string

export type SearchPlatform = string

export type SourcesRegex = string
