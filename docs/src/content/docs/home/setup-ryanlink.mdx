---
title: Setup Lavalink Node
description: Learn how to setup a ryanlink Server
---

## Lavalink Node

In order to use ryanlink, you need a Lavalink Node, you can host them yourself pretty easily.
...
If you want to use stuff like spotify, deezer, more filters, lyrics, new youtube ... then you need to also install [**plugins (to ryanlink.**](https://lavalink.dev/plugins.html)
...
ryanlink.
  server:
    sources:
      youtube: false # Using Youtube nativly on ryanlink is deprecated, disable it and use https://github.com/lavalink-devs/youtube-source instead.
    ...
    gc-warnings: true
  plugins:
    - dependency: 'dev.ryanlink.youtube:youtube-plugin:1.18.0' # https://github.com/lavalink-devs/youtube-source
