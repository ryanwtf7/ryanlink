---
title: Setup Lavalink
description: Learn how to setup a Lavalink Server for Ryanlink.
---

import { LinkCard, Card, CardGrid, Steps, Badge } from '@astrojs/starlight/components';

# Setup Lavalink

To use **Ryanlink**, you need a Lavalink Server. Whether you choose to host it locally or use a premium provider, our engine is designed for absolute technical compatibility.

## Hosting Options

<CardGrid>
  <Card title="Managed Hosting" icon="rocket">
    Avoid the hassle of manual configuration. Use **HeavenCloud** forAMD Ryzen 9 9950X performance.
    <LinkCard
      title="HeavenCloud Lavalink"
      description="60 Gbps Network, 120 Tbps DDoS Shield. Global Regions."
      href="/ryanlink/home/lavalink-hosting"
    />
  </Card>
  <Card title="Self-Hosted Node" icon="seti:javascript">
    Follow the [**Official Lavalink Guide**](https://lavalink.dev/getting-started/index.html) to get started on your own server.
  </Card>
</CardGrid>
...
<Steps>
1. **Lavalink v4.0+**: Native support for v4 filters and plugin architectures.
2. **Plugins**: For features like Spotify, Lyrics, and SponsorBlock, ensure [**plugins**](https://lavalink.dev/plugins.html) are installed.
3. **Smart Tier Integration**: Review the [**Architecture Overview**](/ryanlink/home/smart-engine) to understand how Ryanlink manages node health.
</Steps>
